...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SecureUnlock",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull BeaconManagerDidExitRegionNotification;)
+ (NSNotificationName _Nonnull)BeaconManagerDidExitRegionNotification SWIFT_WARN_UNUSED_RESULT;
@end
